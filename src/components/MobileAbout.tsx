...
export default function MobileAbout() {
  ...
  return (
    <section className="py-10 px-4">
      ...
      <div className="bg-zinc-100 dark:bg-gray-800 rounded-3xl  p-6 mb-8">
        <Image
        ...
        <div className="space-y-2 mb-6">
          <div><span className="font-semibold">Name:</span> {personalInfo.name}</div>
          <div><span className="font-semibold">Birthday:</span> {personalInfo.birthday}</div>
          <div><span className="font-semibold">Phone:</span> {personalInfo.phone}</div>
          <div><span className="font-semibold">Email:</span> {personalInfo.email}</div>
          <div><span className="font-semibold">Location:</span> {personalInfo.location}</div>
          <div><span className="font-semibold">Languages:</span> {personalInfo.languages}</div>
          <div><span className="font-semibold">Freelance:</span> {personalInfo.freelance}</div>
        </div>
      </div>
    </section>
  )
